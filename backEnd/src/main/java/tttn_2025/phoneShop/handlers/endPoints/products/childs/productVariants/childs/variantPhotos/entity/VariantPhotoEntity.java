package tttn_2025.phoneShop.handlers.endPoints.products.childs.productVariants.childs.variantPhotos.entity;
...
@Entity
@Table(name = "variant_photos")
@Data
@AllArgsConstructor
@NoArgsConstructor
@Builder
@EqualsAndHashCode(callSuper = false)
public class VariantPhotoEntity extends AuditableEntity {
